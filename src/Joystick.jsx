...
export default function JoystickUI() {
  ...
  return (
    <div className="mobile-controls">
      <div style={{ position: 'absolute', bottom: 'calc(env(safe-area-inset-bottom, 0px) + 30px)', left: '20px', zIndex: 1000, touchAction: 'none', pointerEvents: 'auto' }}>
        <div 
          ref={baseRef}
      ...
      <div 
        style={{ 
          position: 'absolute', bottom: 'calc(env(safe-area-inset-bottom, 0px) + 30px)', right: '20px', zIndex: 1000, 
